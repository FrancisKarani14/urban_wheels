    ...
    >
      ...
      >
        ...
        <section className='mb-5'>
          <p className='text-base'>From quick weekend rides to big business moments, <br /> grand launches to unforgettable dates</p>
          <p className='text-base'>we’re the wheels that move your moments.</p>
        </section>

        <section className='flex gap-3 items-start justify-start'>
          <Link to="/book" className='bg-[#FFDB58] p-2 text-base text-[#09090B] rounded-sm'>
            Reserve your car
          </Link>
